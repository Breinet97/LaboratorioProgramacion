...
if (isset($_POST['numeroDocumento'], $_POST['referencia'], $_POST['fecha'], $_POST['estado']) && is_array($clientes) && count($clientes) > 0) {
...
if ($idcliente === null) {
    $mensaje = 'El cliente no está en la base de datos. <a href="../vista/pestCliente.php">¿Deseas registrar al cliente?</a>';
} else {
    ...
    if ($result) {
        $mensaje = 'Datos guardados. <a href="../vista/pestDetFac.php">Agregar los artículos de la factura</a>';
    } else {
